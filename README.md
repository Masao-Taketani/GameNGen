...
- start_from_pixels (bool): Start autoregressive inference using original images. If not specified, the program starts autoregressive inference using latent images
- dataset_basepath: Specify your parquet directory path if `start_from_pixels` flag is raised. Otherwise, specify your pt directory path
- num_episodes: Total number of episodes to generate
- episode_length: Total steps for each episode to generate
- unet_model_folder: Specify your trained U-net folder
- vae_ft_model_folder: Specify your finetuned VAE folder
- num_inference_steps: Number of inference steps to generate each frame
